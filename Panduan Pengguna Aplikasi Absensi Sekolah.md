...
Panduan ini disusun secara modular, memungkinkan Anda untuk langsung menuju bagian yang relevan dengan peran dan kebutuhan Anda. Gunakan **Daftar Isi** untuk navigasi cepat. Setiap bagian akan menyajikan instruksi langkah-demi-langkah, dilengkapi dengan penjelasan fungsi dan tips.
...
3.  Klik tombol **Kirim Tautan Reset Kata Sandi**.
...
**Fitur:**
*   **Grafik Absensi Keseluruhan:** Menampilkan tren absensi siswa.
...
Halaman ini digunakan untuk mencatat kehadiran siswa menggunakan pemindai QR Code.

**Fitur:**
*   **Pemindai QR Code:** Menggunakan kamera perangkat untuk memindai QR Code pada kartu identitas siswa.
*   **Daftar Siswa Terpindai:** Menampilkan siswa yang berhasil diabsen dalam sesi saat ini.
...
4.  Setelah berhasil dipindai, nama siswa akan muncul di daftar siswa terpindai, dan status absensi akan tercatat.
...
1.  Pada halaman Rekap Absensi, klik tombol **Tambah Absensi Baru**.
2.  Pilih **Siswa**, **Kelas**, **Mata Pelajaran**, **Tanggal**, dan **Status Absensi** (Hadir, Sakit, Izin, Alpha).
...
1.  Setelah memfilter data absensi sesuai kebutuhan, klik tombol **Ekspor ke Excel**.
2.  File Excel berisi data absensi yang ditampilkan akan diunduh.
...
1.  Pada halaman Pengaturan Aplikasi, cari bagian **Manajemen Aset Kartu**.
2.  Anda dapat mengunggah gambar latar belakang atau elemen desain lain untuk kartu identitas siswa.
3.  Untuk mengunggah: Klik **Unggah Gambar**, pilih file, lalu **Simpan**.
4.  Untuk menghapus: Klik ikon **Hapus** di samping gambar yang ingin dihapus.

#### Konfigurasi Cetak Kartu

1.  Pada halaman Pengaturan Aplikasi, cari bagian **Konfigurasi Cetak Kartu**.
2.  Sesuaikan tata letak cetak kartu identitas siswa, seperti posisi teks, ukuran font, dan elemen desain.
3.  Gunakan fitur pratinjau untuk melihat hasil perubahan.
...
3.  Isi detail pengguna seperti Nama, Email, Kata Sandi, dan pilih **Peran** (Admin, Guru, atau Siswa).
4.  Jika peran Siswa, tambahkan detail profil siswa (misalnya, NISN, Kelas).
5.  Klik tombol **Simpan**.

#### Melihat dan Mengedit Detail Pengguna

1.  Pada daftar Manajemen Pengguna, temukan pengguna yang ingin dilihat/diedit.
2.  Klik nama pengguna atau ikon **Edit** di sampingnya.
3.  Perbarui informasi yang diperlukan.
4.  Klik tombol **Simpan Perubahan**.

#### Mengaktifkan/Menonaktifkan Akun

1.  Pada daftar Manajemen Pengguna, temukan pengguna yang ingin diaktifkan/dinonaktifkan.
2.  Klik tombol **Aktifkan** atau **Nonaktifkan** (biasanya berupa toggle atau ikon status).
...
**Menghapus Massal:**
1.  Pilih beberapa pengguna dengan mencentang kotak di sampingnya.
2.  Klik tombol **Aksi Massal** atau **Hapus Terpilih**.
3.  Konfirmasi penghapusan.
...
**Mengimpor Pengguna:**
1.  Pada halaman Manajemen Pengguna, klik tombol **Impor Pengguna**.
2.  Unduh template Excel yang disediakan.
3.  Isi data pengguna ke dalam template.
4.  Unggah file Excel yang sudah diisi.
5.  Ikuti instruksi untuk memproses impor.

**Mengekspor Pengguna:**
1.  Pada halaman Manajemen Pengguna, klik tombol **Ekspor Pengguna**.
2.  File Excel berisi data semua pengguna akan diunduh.

#### Mencetak Kartu Siswa

1.  Pada daftar Manajemen Pengguna, temukan siswa yang ingin dicetak kartunya.
2.  Klik ikon **Cetak Kartu** di samping nama siswa.
3.  Pilih opsi cetak dan sesuaikan pengaturan printer jika diperlukan.
...
2.  Klik tombol **Tambah Kelas Baru**.
3.  Isi nama kelas dan detail lainnya.
4.  Klik tombol **Simpan**.

#### Melihat dan Mengedit Detail Kelas

1.  Pada daftar Manajemen Kelas, temukan kelas yang ingin dilihat/diedit.
2.  Klik nama kelas atau ikon **Edit** di sampingnya.
3.  Perbarui informasi yang diperlukan.
4.  Klik tombol **Simpan Perubahan**.

#### Mengelola Anggota Kelas (Menambah/Mengeluarkan Siswa)

1.  Pada halaman detail kelas, cari bagian **Anggota Kelas**.
2.  Untuk menambah siswa: Klik **Tambah Siswa**, pilih siswa dari daftar, lalu **Tambahkan**.
3.  Untuk mengeluarkan siswa: Klik ikon **Keluarkan** di samping nama siswa.

#### Mencetak Kartu Kelas

1.  Pada daftar Manajemen Kelas, temukan kelas yang ingin dicetak kartu siswanya.
2.  Klik ikon **Cetak Kartu Kelas**.
3.  Semua kartu identitas siswa dalam kelas tersebut akan disiapkan untuk dicetak.

#### Mencetak Jadwal Kelas

1.  Pada daftar Manajemen Kelas, temukan kelas yang ingin dicetak jadwalnya.
2.  Klik ikon **Cetak Jadwal Kelas**.
3.  Jadwal pelajaran untuk kelas tersebut akan disiapkan untuk dicetak.
...
Dashboard Guru adalah halaman utama yang menampilkan ringkasan informasi penting bagi guru.

**Fitur:**
*   **Ringkasan Jadwal Mengajar:** Menampilkan jadwal mengajar yang akan datang.
*   **Statistik Absensi Kelas:** Ringkasan absensi siswa di kelas yang diajar.
...
2.  Tinjau ringkasan jadwal dan statistik absensi untuk mendapatkan informasi terkini.
...
Halaman ini khusus untuk Guru melihat jadwal mengajarnya.

#### Melihat Jadwal Pribadi

1.  Navigasi ke menu **Jadwal Mengajar Guru**.
2.  Halaman ini akan menampilkan daftar semua jadwal mengajar Anda.

#### Melihat Semua Jadwal Pelajaran

1.  Pada halaman Jadwal Mengajar Guru, mungkin ada opsi untuk **Lihat Semua Jadwal** (jika diizinkan).
2.  Ini akan menampilkan seluruh jadwal pelajaran yang ada di sekolah.

#### Mengekspor Jadwal Mengajar

1.  Pada halaman Jadwal Mengajar Guru, klik tombol **Ekspor Jadwal**.
...
*   Jadwal Mengajar Guru: [Lihat Jadwal Mengajar Guru](#jadwal-mengajar-guru)
