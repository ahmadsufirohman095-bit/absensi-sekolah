    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div x-data="jadwalPage({
                allJadwal: {{ json_encode($allJadwal) }},
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex flex-col md:flex-row justify-between md:items-center mb-6 gap-4">
                        <div>
                            ...
                            @isset($kelasName)
                                <p class="text-lg text-gray-600 dark:text-gray-400">Kelas {{ $kelasName }}</p>
                            @else
                                <p class="text-md text-gray-500 dark:text-gray-400">Menampilkan semua jadwal</p>
                            @endisset
                        </div>
                        <div class="flex items-center space-x-2">
                            <a href="{{ route('jadwal.create', ['kelas_id' => $kelasId]) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700 shadow-sm">
                                        ...
                                        <tr>
                                            <td :colspan="hariOrder.length + 1" class="text-center py-24 bg-white dark:bg-gray-800">
                                                <div class="text-gray-400 dark:text-gray-500">
                                                    ...
                                                    <div class="mt-6">
                                                        <a href="{{ route('jadwal.index') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-md hover:bg-indigo-700 shadow-sm">
                ...
                <div x-show="showImportModal" class="fixed inset-0 bg-gray-900 bg-opacity-75 z-50 flex items-center justify-center p-4" x-cloak>
                    <div @click.away="showImportModal = false" class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md">
                        ...
                        <div class="text-sm mb-4">
                            <a href="{{ route('jadwal.importTemplate') }}" class="font-medium text-indigo-600 dark:text-indigo-400 hover:underline" data-turbo="false">
                ...
                <div x-show="showExportModal" class="fixed inset-0 bg-gray-900 bg-opacity-75 z-50 flex items-center justify-center p-4" x-cloak>
                    <div @click.away="showExportModal = false" class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md">
                        ...
                        <form action="{{ route('jadwal.export') }}" method="GET" data-turbo="false">
                            <div class="space-y-4">
                                <div>
        ...
        function jadwalPage(config) {
            return {
                ...
                async bulkDelete() {
                    ...
                    try {
                        const response = await axios.post('{{ route("jadwal.bulkDestroy") }}', {
