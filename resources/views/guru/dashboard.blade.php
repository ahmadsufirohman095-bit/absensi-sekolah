                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md">
                        <div class="p-6">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-blue-900 dark:text-blue-300">{{ $daftarSiswaWaliKelas->count() }}</span>
                            </div>
                            @if($kelasDiampu)
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Kelas: <span class="font-medium">{{ $kelasDiampu->nama_kelas }}</span></p>
                            @endif
                            <div class="space-y-3 max-h-80 overflow-y-auto pr-2">
                                @forelse($daftarSiswaWaliKelas as $siswa)
