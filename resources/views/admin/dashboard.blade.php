<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8 xl:px-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg flex items-center justify-between transform transition duration-300 hover:scale-105 hover:shadow-xl">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-indigo-600 dark:text-indigo-400 mt-1">{{ $totalUsers }}</p>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg flex items-center justify-between transform transition duration-300 hover:scale-105 hover:shadow-xl">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600 dark:text-green-400 mt-1">{{ $totalKelas }}</p>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg flex items-center justify-between transform transition duration-300 hover:scale-105 hover:shadow-xl">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-yellow-600 dark:text-yellow-400 mt-1">{{ $totalMataPelajaran }}</p>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg flex items-center justify-between transform transition duration-300 hover:scale-105 hover:shadow-xl">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-red-600 dark:text-red-400 mt-1">{{ $totalJadwalAbsensi }}</p>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4 flex items-center"><svg class="h-6 w-6 mr-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg> Kehadiran per Mata Pelajaran Hari Ini</h3>
    ...
    @push('scripts')
    {{-- adminDashboardCharts.js diimpor melalui app.js, tidak perlu @vite terpisah di sini --}}
    @endpush
</x-app-layout>
