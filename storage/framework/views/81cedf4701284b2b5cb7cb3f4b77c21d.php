        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <?php if($user->role === 'admin' && $user->adminProfile): ?>
                        <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-base">
                                ...
                                <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm"><strong>Tanggal Lahir:</strong> <span class="text-gray-700 dark:text-gray-300"><?php echo e($user->adminProfile->tanggal_lahir ? \Carbon\Carbon::parse($user->adminProfile->tanggal_lahir)->translatedFormat('d F Y') : '-'); ?></span></div>
                    ...
                    <?php elseif($user->role === 'tu' && $user->tuProfile): ?>
                        <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                            <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-5">Detail Profil Tata Usaha (TU)</h4>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-base">
                                <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm"><strong>Jabatan:</strong> <span class="text-gray-700 dark:text-gray-300"><?php echo e($user->tuProfile->jabatan ?? '-'); ?></span></div>
                                <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm"><strong>Telepon:</strong> <span class="text-gray-700 dark:text-gray-300"><?php echo e($user->tuProfile->telepon ?? '-'); ?></span></div>
                                <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm"><strong>Tanggal Bergabung:</strong> <span class="text-gray-700 dark:text-gray-300"><?php echo e($user->tuProfile->tanggal_bergabung ? \Carbon\Carbon::parse($user->tuProfile->tanggal_bergabung)->translatedFormat('d F Y') : '-'); ?></span></div>
                                <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm"><strong>Tanggal Lahir:</strong> <span class="text-gray-700 dark:text-gray-300"><?php echo e($user->tuProfile->tanggal_lahir ? \Carbon\Carbon::parse($user->tuProfile->tanggal_lahir)->translatedFormat('d F Y') : '-'); ?></span></div>
                                <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm"><strong>Tempat Lahir:</strong> <span class="text-gray-700 dark:text-gray-300"><?php echo e($user->tuProfile->tempat_lahir ?? '-'); ?></span></div>
                                <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm"><strong>Jenis Kelamin:</strong> <span class="text-gray-700 dark:text-gray-300"><?php echo e($user->tuProfile->jenis_kelamin ? ucfirst($user->tuProfile->jenis_kelamin) : '-'); ?></span></div>
                            </div>
                        </div>
                    <?php elseif($user->role === 'other' && $user->otherProfile): ?>
                        <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                            <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-5">Detail Profil Lainnya (<?php echo e($user->custom_role); ?>)</h4>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-base">
                                <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm"><strong>Jabatan:</strong> <span class="text-gray-700 dark:text-gray-300"><?php echo e($user->otherProfile->jabatan ?? '-'); ?></span></div>
                                <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm"><strong>Telepon:</strong> <span class="text-gray-700 dark:text-gray-300"><?php echo e($user->otherProfile->telepon ?? '-'); ?></span></div>
                                <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm"><strong>Tanggal Bergabung:</strong> <span class="text-gray-700 dark:text-gray-300"><?php echo e($user->otherProfile->tanggal_bergabung ? \Carbon\Carbon::parse($user->otherProfile->tanggal_bergabung)->translatedFormat('d F Y') : '-'); ?></span></div>
                                <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm"><strong>Tanggal Lahir:</strong> <span class="text-gray-700 dark:text-gray-300"><?php echo e($user->otherProfile->tanggal_lahir ? \Carbon\Carbon::parse($user->otherProfile->tanggal_lahir)->translatedFormat('d F Y') : '-'); ?></span></div>
                                <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm"><strong>Tempat Lahir:</strong> <span class="text-gray-700 dark:text-gray-300"><?php echo e($user->otherProfile->tempat_lahir ?? '-'); ?></span></div>
                                <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm"><strong>Jenis Kelamin:</strong> <span class="text-gray-700 dark:text-gray-300"><?php echo e($user->otherProfile->jenis_kelamin ? ucfirst($user->otherProfile->jenis_kelamin) : '-'); ?></span></div>
                                <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-md shadow-sm md:col-span-2"><strong>Alamat:</strong> <span class="text-gray-700 dark:text-gray-300"><?php echo e($user->otherProfile->alamat ?? '-'); ?></span></div>
                            </div>
                        </div>
...
<?php endif; ?><?php /**PATH /home/ruanmei/Dokumen/xampp/htdocs/absensi-sekolah/resources/views/users/show.blade.php ENDPATH**/ ?>