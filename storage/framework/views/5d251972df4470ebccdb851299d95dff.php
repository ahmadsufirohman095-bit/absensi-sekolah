     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                <?php echo e(__('Laporan Absensi Saya')); ?>

            </h2>
        </div>
     <?php $__env->endSlot(); ?>

    <div class="py-12" x-data="{ startDate: '<?php echo e(request('start_date', '')); ?>', endDate: '<?php echo e(request('end_date', '')); ?>' }">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div x-data="{ showFilters: true }" x-init="flatpickr('.flatpickr-date', { dateFormat: 'Y-m-d', altInput: true, altFormat: 'd F Y', theme: document.documentElement.classList.contains('dark') ? 'dark' : 'default' });" class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg mb-6 border border-gray-200 dark:border-gray-700">
                        ...
                        <div x-show="showFilters" x-collapse>
                            <form method="GET" action="<?php echo e(route('siswa.laporan_absensi')); ?>" class="space-y-4">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'start_date','name' => 'start_date','type' => 'text','class' => 'mt-1 block w-full flatpickr-date','xModel' => 'startDate']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'start_date','name' => 'start_date','type' => 'text','class' => 'mt-1 block w-full flatpickr-date','x-model' => 'startDate']); ?>
...
<?php endif; ?>
                                    ...
                                    <div>
                                        ...
                                        <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'end_date','name' => 'end_date','type' => 'text','class' => 'mt-1 block w-full flatpickr-date','xModel' => 'endDate']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'end_date','name' => 'end_date','type' => 'text','class' => 'mt-1 block w-full flatpickr-date','x-model' => 'endDate']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
                                ...
                                <div class="flex justify-end space-x-2">
                                    <a :href="`<?php echo e(route('siswa.laporan_absensi.export')); ?>?start_date=${startDate}&end_date=${endDate}`" 
                                       data-turbo="false"
                                    ...
                                    <a href="<?php echo e(route('siswa.laporan_absensi')); ?>" class="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 dark:bg-gray-500 dark:hover:bg-gray-600">
                    ...
                    <div class="overflow-x-auto bg-white dark:bg-gray-800 rounded-lg shadow">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <?php $__empty_1 = true; $__currentLoopData = $absensiSiswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $absensi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                        <td class="px-6 py-4 whitespace-nowrap"><?php echo e(\Carbon\Carbon::parse($absensi->tanggal_absensi)->translatedFormat('d F Y')); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap"><?php echo e($absensi->waktu_masuk ? \Carbon\Carbon::parse($absensi->waktu_masuk)->format('H:i') : '-'); ?></td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                <?php switch($absensi->status):
                                                    case ('hadir'): ?> bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100 <?php break; ?>
                                                    <?php case ('terlambat'): ?> bg-yellow-100 text-yellow-800 dark:bg-yellow-800 dark:text-yellow-100 <?php break; ?>
                                                    <?php case ('sakit'): ?> bg-blue-100 text-blue-800 dark:bg-blue-800 dark:text-blue-100 <?php break; ?>
                                                    <?php case ('izin'): ?> bg-indigo-100 text-indigo-800 dark:bg-indigo-800 dark:text-indigo-100 <?php break; ?>
                                                    <?php case ('alpha'): ?> bg-red-100 text-red-800 dark:bg-red-800 dark:text-red-100 <?php break; ?>
                                                <?php endswitch; ?>">
                                                <?php echo e(ucfirst($absensi->status)); ?>

                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap"><?php echo e($absensi->keterangan ?? '-'); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap"><?php echo e(ucfirst(str_replace('_', ' ', $absensi->attendance_type ?? 'N/A'))); ?></td>
                                    </tr>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\absensi-sekolah\resources\views/rekap_absensi/laporan_siswa.blade.php ENDPATH**/ ?>