...
<?php $component->withAttributes([]); ?>
        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div id="scanner-section" class="hidden" <?php if($user->isAdmin()): ?> style="display: none;" <?php endif; ?>>
                        <!-- 1. Camera Viewport -->
                    ...
                    <div id="feedback-section" class="hidden" <?php if($user->isAdmin()): ?> style="display: none;" <?php endif; ?>>
                        <!-- 2. Status & History -->
                        <div class="mt-6">
    ...
    <script>
        ...
        window.allAvailableSchedules = <?php echo json_encode($availableSchedules, 15, 512) ?>; // Store all schedules
        ...
        window.isUserAdmin = <?php echo e($user->isAdmin() ? 'true' : 'false'); ?>; // Pass user role to JS
        window.initialJadwalId = <?php echo json_encode(request('jadwal_id'), 15, 512) ?>; // Get jadwal_id from URL
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\absensi-sekolah\resources\views/scan/index.blade.php ENDPATH**/ ?>