                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                                    ...
                                    <div>
                                        ...
                                        <select name="role" id="role" class="block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                                            ...
                                            <option value="tu" <?php if(request('role') == 'tu'): echo 'selected'; endif; ?>>TU</option>
                                            <option value="other" <?php if(request('role') == 'other'): echo 'selected'; endif; ?>>Lainnya</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="md:col-span-2 lg:col-span-4 flex justify-end gap-2">
                                        ...
                                        <a href="<?php echo e(route('users.index', ['kelas_id' => request('kelas_id') ?: '', 'role' => request('kelas_id') ? 'siswa' : ''])); ?>" class="px-4 py-2 bg-gray-300 text-gray-800 font-semibold rounded-md hover:bg-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">Reset Filter</a>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<?php endif; ?>
<?php /**PATH /home/ruanmei/Dokumen/xampp/htdocs/absensi-sekolah/resources/views/users/index.blade.php ENDPATH**/ ?>