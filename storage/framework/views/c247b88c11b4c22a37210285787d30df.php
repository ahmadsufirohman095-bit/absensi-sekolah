    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div x-data="jadwalAbsensiPegawaiPage({
                allJadwalAbsensiPegawai: <?php echo e(json_encode($allJadwalAbsensiPegawai)); ?>,
                timeSlots: <?php echo e(json_encode($timeSlots)); ?>,
                hariOrder: <?php echo e(json_encode($hariOrder)); ?>,
                userId: <?php echo e($userId ?? 'null'); ?>,
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex flex-col md:flex-row justify-between md:items-center mb-6 gap-4">
                        <div>
                            ...
                            <?php if(isset($userName)): ?>
                                <p class="text-lg text-gray-600 dark:text-gray-400">Untuk: <?php echo e($userName); ?></p>
                            <?php else: ?>
                                <p class="text-md text-gray-500 dark:text-gray-400">Menampilkan semua jadwal absensi pegawai</p>
                            <?php endif; ?>
                        </div>
                        <div class="flex items-center space-x-2">
                            <a href="<?php echo e(route('jadwal-absensi-pegawai.create', ['user_id' => $userId])); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700 shadow-sm">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg mb-6 border border-gray-200 dark:border-gray-700">
                        <form action="<?php echo e(route('jadwal-absensi-pegawai.index')); ?>" method="GET">
                                        ...
                                        <tr>
                                            <td :colspan="hariOrder.length + 1" class="text-center py-24 bg-white dark:bg-gray-800">
                                                <div class="text-gray-400 dark:text-gray-500">
                                                    ...
                                                    <div class="mt-6">
                                                        <a href="<?php echo e(route('jadwal-absensi-pegawai.index')); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-md hover:bg-indigo-700 shadow-sm">
                ...
                <div x-show="showImportModal" class="fixed inset-0 bg-gray-900 bg-opacity-75 z-50 flex items-center justify-center p-4" x-cloak>
                    <div @click.away="showImportModal = false" class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md">
                        ...
                        <div class="text-sm mb-4">
                            <a href="<?php echo e(route('jadwal-absensi-pegawai.importTemplate')); ?>" class="font-medium text-indigo-600 dark:text-indigo-400 hover:underline" data-turbo="false">
                                <i class="fa-solid fa-download mr-1"></i>
                                Unduh Template Excel
                            </a>
                        </div>

                        <form action="<?php echo e(route('jadwal-absensi-pegawai.import')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div>
                ...
                <div x-show="showExportModal" class="fixed inset-0 bg-gray-900 bg-opacity-75 z-50 flex items-center justify-center p-4" x-cloak>
                    <div @click.away="showExportModal = false" class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md">
                        ...
                        <form action="<?php echo e(route('jadwal-absensi-pegawai.export')); ?>" method="GET" data-turbo="false">
                            <div class="space-y-4">
                                <div>
        ...
        function jadwalAbsensiPegawaiPage(config) {
            return {
                ...
                async bulkDelete() {
                    ...
                    try {
                        const response = await axios.post('<?php echo e(route("jadwal-absensi-pegawai.bulkDestroy")); ?>', {
...
<?php endif; ?>
<?php /**PATH /home/ruanmei/Dokumen/xampp/htdocs/absensi-sekolah/resources/views/jadwal-absensi-pegawai/index.blade.php ENDPATH**/ ?>