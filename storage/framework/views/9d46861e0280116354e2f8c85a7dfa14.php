...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('Tambah Jadwal Absensi Pegawai')); ?>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100" x-data="jadwalAbsensiPegawaiCreateManager">
                    ...
                    <form action="<?php echo e(route('jadwal-absensi-pegawai.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div id="schedule-items-container" class="space-y-8" x-ref="container">
                            
                            <?php echo $__env->make('jadwal-absensi-pegawai.partials.schedule-item', ['index' => 0, 'users' => $users, 'hariOptions' => $hariOptions], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                        ...
                        <div class="flex items-center justify-between mt-8">
                            ...
                            <div class="flex items-center">
                                <a href="<?php echo e(route('jadwal-absensi-pegawai.index')); ?>"
...
<?php $component->withAttributes(['class' => 'ml-4']); ?>
                                    <?php echo e(__('Simpan Semua Jadwal Absensi Pegawai')); ?>
...
<?php endif; ?>
    ...
    <template id="schedule-item-template" x-ref="template">
        <?php echo $__env->make('jadwal-absensi-pegawai.partials.schedule-item', ['index' => '__INDEX__', 'users' => $users, 'hariOptions' => $hariOptions], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </template>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('jadwalAbsensiPegawaiCreateManager', () => ({
                ...
                hariOptions: <?php echo json_encode($hariOptions, 15, 512) ?>,
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\absensi-sekolah\resources\views/jadwal-absensi-Pegawai/create.blade.php ENDPATH**/ ?>