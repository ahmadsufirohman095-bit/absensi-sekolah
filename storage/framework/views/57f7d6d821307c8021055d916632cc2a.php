                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md">
                        <div class="p-6">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <span class="bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300"><?php echo e($siswaAbsen->count()); ?></span>
                            </div>
                            <div class="space-y-3 max-h-80 overflow-y-auto pr-2">
                                <?php $__empty_1 = true; $__currentLoopData = $siswaAbsen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $siswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
