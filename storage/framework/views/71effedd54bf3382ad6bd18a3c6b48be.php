...
<head>
    ...
    ?>
    <link rel="icon" href="<?php echo e(asset($faviconPath . '?v=' . time())); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/print.css')); ?>" media="print" data-turbo-track="reload" />
...
<body class="font-sans antialiased">
    <div x-data="{ sidebarOpen: localStorage.getItem('sidebarOpen') === 'true' || (localStorage.getItem('sidebarOpen') === null && window.innerWidth >= 1024) }"
        ...
        <aside class="fixed inset-y-0 left-0 z-30 transform transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 shadow-lg lg:rounded-br-lg"
            ...
            <?php echo $__env->make('layouts.navigation', ['sidebarOpen' => 'sidebarOpen'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </aside>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('notifications.index'),'class' => ''.e($notification->read_at ? '' : 'font-bold').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('notifications.index')),'class' => ''.e($notification->read_at ? '' : 'font-bold').'']); ?>
                                        <?php echo e($notification->data['message']); ?>

                                        <span class="block text-xs text-gray-500 dark:text-gray-400"><?php echo e($notification->created_at->diffForHumans()); ?></span>
...
<?php endif; ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginal68cb1971a2b92c9735f83359058f7108 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal68cb1971a2b92c9735f83359058f7108 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('notifications.index')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dropdown-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('notifications.index'))]); ?>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                         <?php $__env->slot('trigger', null, []); ?> 
                            <button
                                ...
                                <img class="h-8 w-8 rounded-full object-cover me-2" src="<?php echo e(Auth::user()->foto_url); ?>"
                                    alt="<?php echo e(Auth::user()->name); ?>">
                                <div class="hidden md:block"><?php echo e(Auth::user()->name); ?></div>
...
<?php /**PATH /home/ruanmei/Dokumen/xampp/htdocs/absensi-sekolah/resources/views/layouts/app.blade.php ENDPATH**/ ?>