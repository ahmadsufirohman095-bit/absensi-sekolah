...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginal2e340925a8bf40d3894bf118093fdd54 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2e340925a8bf40d3894bf118093fdd54 = $attributes; } ?>
<?php $component = App\View\Components\SideNavLink::resolve(['active' => request()->routeIs('users.qr-generator'),'sidebarOpen' => $sidebarOpen] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('side-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\SideNavLink::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('users.qr-generator')),'class' => 'pl-4']); ?>
                         <?php $__env->slot('icon', null, []); ?> 
                            <i class="fas fa-qrcode w-6 h-6 flex items-center justify-center"></i>
                         <?php $__env->endSlot(); ?>
                        <?php echo e(__('Generate QR Codes')); ?>
...
<?php endif; ?>
 ...
 <?php /**PATH /home/ruanmei/Dokumen/xampp/htdocs/absensi-sekolah/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>